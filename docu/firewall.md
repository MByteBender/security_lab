...
| 3   | DMZ to LAN                          | DMZ · windows2008_server          | LAN · wazuh                   | wazuhAgent | **Accept** | Enabled      | IPS, AV, Web, App, QoS, HB, LinkedNAT, PRX, LOG |
...
| 8   | WAN to DMZ               | WAN, Any host                     | DMZ · windows2008_server | HTTP, HTTPS | **Accept** | Enabled      | IPS, AV, Web, App, QoS, HB, LinkedNAT, PRX, LOG |
...
| 11  | #Default_Network_Policy            | LAN, Any host      | WAN, Any host      | Any           | **Accept** | Enabled      | IPS, AV, Web, App, QoS, HB, LinkedNAT |
...
| --- | --------------------------- | --------------- | ---------------- | -------------------- | ----------------- | ------------------ | --- | ---------- |
| 1   | #NAT_Default_Network_Poli   | Any host        | Any service      | Any host             | MASQ              | Any interface      | #3  | Unused     |
...
| 2   | Lab_TLS_interception     | LAN, DMZ, Any host, Anybody | Any zone, Any host | Any website, Any service                          | Block insecure SSL    | **Decrypt**       |
...
| SecurityAppliance_SSL_CA | `Sophos SSL CA_LvrFuGKERk02RI5` | 2015-08-01 | 2036-12-31  | Built-in                       |
...
| lantowan_general | General policy for LAN to WAN traffic     |
| lantowan_strict  | Strict policy for LAN to WAN traffic      |
...
| ------------- | ----------- | ------------------------- | ------------ | ------ |
| DHCP_Port2_GW | 10.0.30.110 | Port2 (WAN, 10.0.30.1/24) | On           | Active |
