...
resource "proxmox_virtual_environment_vm" "ubuntuDesktop" {
  ...
  provisioner "file" {
    ...
    destination = "/home/ubuntusamba-common_3.4.7~dfsg-1ubuntu1_amd64.deb"
  }

  provisioner "file" {
    source = "${path.module}/http/libwbclient0_3.4.7~dfsg-1ubuntu1_amd64.deb"
    destination = "/home/ubuntulibwbclient0_3.4.7~dfsg-1ubuntu1_amd64.deb"
  }

  provisioner "file" {
    source = "${path.module}/http/samba-common-bin_3.4.7~dfsg-1ubuntu1_amd64.deb"
    destination = "/home/ubuntusamba-common-bin_3.4.7~dfsg-1ubuntu1_amd64.deb"
  }
