...
# ... after the RunAs Admin window opens ...
    ...
    "powershell -NonInteractive -Command \"$net = [Activator]::CreateInstance([Type]::GetTypeFromCLSID([Guid]'{DCB00C01-570F-4A9B-8D69-199FDBA5723B}')); $net.GetNetworkConnections() | ForEach-Object {$_.GetNetwork().SetCategory(1)}\"<wait2s><enter>",
